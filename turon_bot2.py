...
CONTACT_PHONE_2 = "+998 78 333 14 45"  # TODO: to'liq raqamni shu yerga kiriting
...
INFO_TEXT = (
    ...
    "🎁 Chegirma: Barcha kurslarga (bir oiladan 2 kishi kelsa ulardan biriga yoki 10% vaucher bilan kelsa)\n"
...
async def cmd_start(message: Message, state: FSMContext):
    ...
    await message.answer(
        "Assalomu alaykum! 👋\n"
        "Men Turon o'quv markazining AI yordamchisiman.\n"
